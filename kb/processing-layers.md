...
riflessivi, la KB è il _substrato_ (la system image) che tutti gli stadi leggono
e scrivono — i1 la alimenta, o2 ne attinge. La KB materializza il riflessivo come
livello, ma come system image è trasversale (cfr. `system-image`). Il _behavioral_, sede dell'operazione esperta e di
