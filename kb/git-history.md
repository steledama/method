...
Nel metodo la git history sostiene la leggerezza della documentazione. I nodi descrivono il presente permanente; i fili `i3/` interpretano le decisioni significative; git conserva il dettaglio analitico di ogni modifica. Quando serve sapere esattamente cosa è cambiato, si torna al commit.
