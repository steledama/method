...
- **Compare · i3 — D**: la valutazione-osservatorio — confrontare la fotografia dei quattro domini contro gli obiettivi-runtime — è inquadrata da `adopter-comparison` (la lente) e vive in parte nei fili adottanti di `i3/`; il filo `i3/audit-adottanti.md` la materializza ora come verdetto-runtime a sé, giovane di un solo battito. Presente, in consolidamento.
