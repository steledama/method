...
La tabella nomina, per ciascun artefatto, di cosa è fatto il Mondo e i due versi della cerniera che lo tocca: l'input grezzo (i1) che ne entra per essere percepito e interpretato, e l'azione (o3) che vi ritorna producendo effetti reali. i1 e o3 stanno insieme nello stesso nodo perché o3 non si comprende se non in relazione al Mondo — nasce nell'artefatto e finisce fuori di esso. Gli stadi intermedi (i2/i3 sull'arco di input, o1/o2 su quello di output) vivono nello strato output; il goal contro cui gli input sono confrontati vive nel nodo Goal.

| Artefatto  | Di cosa è fatto il Mondo                                                                                | Input i1 (cosa ne entra)                                                                             | Azione o3 (cosa vi ritorna)                                                                                |
| ---------- | ------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| `salute`   | il corpo, la mente, le visite mediche, le sessioni di yoga e meditazione, i sintomi, gli stati mentali  | referti delle visite, sintomi percepiti, stati mentali, esiti delle pratiche                         | sessioni di yoga e meditazione svolte, controlli fatti, scelte alimentari, conversazioni mediche           |
| `economia` | conti correnti, commercialisti, amministratori di condominio, Agenzia delle Entrate, agenti immobiliari | movimenti bancari, bollette, solleciti di pagamento, scadenze fiscali, mail degli agenti immobiliari | email inviate, telefonate, incontri preparati e tenuti, transazioni programmate ed eseguite                |
| `nixos`    | i 5 PC, le due reti, lo storage su disco, la capacità computazionale dei singoli host                   | bug, messaggi di errore, lentezze e appesantimenti, aggiornamenti disponibili                        | deploy e switch applicati, sistema in esecuzione, aggiornamenti installati                                 |
| `bi`       | i fornitori, l'abbinatore, i siti e-commerce col plugin ttimport, il gestionale Danea                   | cataloghi dei fornitori, esportazioni dati da Danea, abbinamenti                                     | payload di disponibilità e prezzi pubblicato al plugin, aggiornamenti dell'intero catalogo inviati ai siti |
