...
| #   | Task                                          | Dip. |
| --- | --------------------------------------------- | ---- |
| 1   | Atrio a tre specie + gradiente di cardinalità | —    |
| 2   | System image visiva: rappresentazione in root | 1    |
| 3   | Fonti pace-layering e maturazione nodo        | —    |
| 4   | Ingest fonti mente estesa (Andy Clark)        | —    |

## Dettagli task

- [Atrio a tre specie + gradiente di cardinalità](tasks/atrio-tre-specie.md)
- [System image visiva: strato di rappresentazione in root](tasks/system-image-visiva.md)
