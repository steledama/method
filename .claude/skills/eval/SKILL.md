...
1. Raccogli ciò che arriva dal Mondo. In `metodo` i canali sono: i marker
   `method-review.md` dei quattro adottanti (via `world/`), gli esiti già
...
(`o3/kb_tools.py audit`), i marker `method-review.md` degli adottanti (via
`world/`) e le percezioni `i1/` non ancora valutate.
