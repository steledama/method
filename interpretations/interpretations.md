...
Indice della collezione `interpretations/`: lo stadio **i2** (Interpret) del ciclo di sviluppo — le sintesi visive che rendono co-presenti le tensioni tra i nodi e aggiornano il modello mentale di chi mantiene il metodo. Il significato dello stadio vive nell'atomo [interpret](../kb/interpret.md); la stessa superficie si legge specularmente come o2 ([specify](../kb/specify.md)). La disciplina del deck come forma navigabile è in [deck](../kb/deck.md). Qui restano l'elenco dei contenuti e la nota di build.
