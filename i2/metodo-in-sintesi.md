...
- i poli non si eseguono: lo **scopo** motiva, il **mondo** è ritagliato dall'artefatto per rilevanza
...
- **agente** — umano · LLM
- **annidamento** — sviluppo (costruisce l'artefatto) · runtime (agisce sul dominio)
- **livello** — macchina · decisione · azione
...
Le tensioni affiorano qui, si chiudono nei nodi — la fonte di verità — e poi il deck si ri-deriva.
