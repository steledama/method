...
- [audit-adottanti.md](audit-adottanti.md) — verdetto aggregato dell'audit mensile `/adopters-review` (primo battito 2026-07-11; marker freschi 2026-08-01): canale del canone vivo, i quattro `aligned` e lo scostamento di `economia` sciolto; tutti attendono la prescrizione della quinta domanda; telos letto dalle code senza toccarle — misura: «Propagare il canone e chiudere il loop»
