...
- [vista-derivata-e-verificata.md](vista-derivata-e-verificata.md) — derivata senza verificata è mezza garanzia: dove le fonti sono più d'una il generatore le legge come contratto e rompe la build; canone in `view`, seconda incarnazione del vincolo di `constraint`; `metodo` aveva la stessa patologia inflittasi potando (vista dei task vuota dall'11 luglio, riparata), watchpoint sul terzo campione — misura: «Canale-perception funzionante»
