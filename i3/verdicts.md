...
- [maturazione-nodi-fondativi.md](maturazione-nodi-fondativi.md) — nessun debito di fonte aperto; il test storico sui 48 nodi ha isolato la norma della macchina come quarta regione `N`, mentre la review completa corrente conferma 45 nodi integri e corregge concentrazione dell'hub, autorità del consenso e confine prescrizione/micromanagement. Audit, copertura e facet sono verdi; restano la maturazione dei nodi in bozza e il secondo specimen esterno della tipologia — misura: «Custodire un canone coerente»
